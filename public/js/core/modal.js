...
(function () {
	'use strict';*/
var modalMaterialize = angular.module('materialize', []);
modalMaterialize.factory('modal', ['$http', '$compile', '$rootScope', '$document', '$q', '$controller', '$timeout',function($http, $compile, $rootScope, $document, $q, $controller, $timeout){
	var service = {
		open: open
	};
